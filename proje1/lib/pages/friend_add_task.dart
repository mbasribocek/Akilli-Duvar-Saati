...
class FriendAddTaskPage extends StatefulWidget {
  final String userId;

  const FriendAddTaskPage({Key? key, required this.userId}) : super(key: key);

  @override
  _FriendAddTaskPageState createState() => _FriendAddTaskPageState();
}

class _FriendAddTaskPageState extends State<FriendAddTaskPage> {
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (gorevAd.isEmpty) {
                    ...
                    writeDataToFirebase2(starttime, finishtime, color);
  ...
  void writeDataToFirebase(String start, String finish, int color) {
    ...
    DatabaseReference tasksFolderReference =
        databaseReference.child(widget.userId).child(start);
  ...
  void writeDataToFirebase2(String start, String finish, int color) {
    final databaseReference = FirebaseDatabase.instance.reference();
