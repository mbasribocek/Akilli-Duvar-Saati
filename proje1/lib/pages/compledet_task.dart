...
class CompletedTaskPage extends StatefulWidget {
  ...
  @override
  CompletedTaskAlertDialogState createState() => CompletedTaskAlertDialogState();
}

class CompletedTaskAlertDialogState extends State<CompletedTaskPage> {
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        child: Form(
          child: Column(
            children: <Widget>[
              Text('Sonlandır butonuna basarsanız tamamladığınız bu görev silinecektir.', style: TextStyle(fontSize: 14)),
